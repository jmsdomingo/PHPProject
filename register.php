        ...
        <div class="row">
            <form method="POST">
                ...
                <div class="col-lg-12">         
                    ...
                    <input class="credentials-input my-2" id="password2" type="password" name="cpassword" minlength="8" placeholder="Confirm password" required><br>
                    <i class="bi bi-eye-slash eye-icon" id="togglePassword2"></i>
                </div>

                <div class="col-lg-12 my-2">         
                    <a href="login" class="hyperlink">Already have an account?</a>
                </div>

                <div class="col-lg-12">         
                    <input type="submit" value="Create Account" name="register" class="create-acc">
                </div>
